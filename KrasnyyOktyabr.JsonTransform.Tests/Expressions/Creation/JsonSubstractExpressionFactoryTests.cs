...
using static KrasnyyOktyabr.JsonTransform.Expressions.Creation.JsonSubstractExpressionFactory;

namespace KrasnyyOktyabr.JsonTransform.Expressions.Creation.Tests;

[TestClass]
public class JsonSubstractExpressionFactoryTests
{
    private Mock<IJsonAbstractExpressionFactory>? _abstractFactoryMock;

    private JsonSubstractExpressionFactory? _substractExpressionFactory;

    [TestInitialize]
    public void Initialize()
    {
        _abstractFactoryMock = new();
        _substractExpressionFactory = new(_abstractFactoryMock.Object);
    }
    ...
    public void Match_ShouldReturnTrue()
    {
        ...
        bool isMatch = _substractExpressionFactory!.Match(input);
    ...
    {
        _substractExpressionFactory!.Create(null!);
    }
    ...
    public void Create_ShouldCreateSumExpression()
    {
        ...
        SubstractExpression expression = _substractExpressionFactory!.Create(input);
