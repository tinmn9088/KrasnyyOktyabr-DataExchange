...
using static KrasnyyOktyabr.JsonTransform.Expressions.Creation.JsonSumExpressionFactory;

namespace KrasnyyOktyabr.JsonTransform.Expressions.Creation.Tests;

[TestClass]
public class JsonSumExpressionFactoryTests
{
    private Mock<IJsonAbstractExpressionFactory>? _abstractFactoryMock;

    private JsonSumExpressionFactory? _sumExpressionFactory;

    [TestInitialize]
    public void Initialize()
    {
        _abstractFactoryMock = new();
        _sumExpressionFactory = new(_abstractFactoryMock.Object);
    }
    ...
    public void Match_ShouldReturnTrue()
    {
        ...
        bool isMatch = _sumExpressionFactory!.Match(input);
    ...
    {
        _sumExpressionFactory!.Create(null!);
    }
    ...
    public void Create_ShouldCreateSumExpression()
    {
        ...
        SumExpression expression = _sumExpressionFactory!.Create(input);
